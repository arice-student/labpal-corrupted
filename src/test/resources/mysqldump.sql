...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `method` (
                          `prefix` varchar(1) NOT NULL DEFAULT 'M',
...
CREATE TABLE `protocol` (
                            `prefix` varchar(1) NOT NULL DEFAULT 'P',
                            `id` int(4) unsigned zerofill NOT NULL AUTO_INCREMENT,
                            `version` varchar(45) NOT NULL,
                            `title` varchar(45) NOT NULL,
                            `client` varchar(45) NOT NULL,
...
CREATE TABLE `test` (
                        ...
                        `analyst` varchar(45) DEFAULT NULL,
                        PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `user` VALUES (1,'Joe','Coyne','jcoyne','supersecret1','1964-04-01'),(2,'Fred','Hensen','fhensen','supersecret2','1988-05-08'),(3,'Barney','Curry','bcurry','supersecret3','1947-11-11'),(4,'Karen','Mack','kmack','supersecret4','1986-07-08'),(5,'Dianne','Klein','dklein','supersecret5','1991-09-22'),(6,'Dawn','Tillman','dtillman','supersecret6','1979-08-30'),(14,'Fred','Flintstone','fflintstone',NULL,'1168-01-01');
...
-- Dump completed on 2021-03-03  1:50:19
